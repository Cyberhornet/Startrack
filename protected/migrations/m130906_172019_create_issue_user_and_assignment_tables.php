...
class m130906_172019_create_issue_user_and_assignment_tables extends CDbMigration
{
	/*public function up()
	{
	}
	...
	{
		echo "m130906_172019_create_issue_user_and_assignment_tables does not support migration down.\n";
		return TRUE;
	}
*/
	...
	{//create the issue table
                    ...
                    $this->addForeignKey("fk_project_user", "tbl_project_user_assignment", "project_id", "tbl_project", "id", "CASCADE",
                    "RESTRICT");
