...
class Issue extends CActiveRecord
{
	...
	public function search()
	{
        ...
        public function getTypeOptions(){
            return array(self::TYPE_BUG=>'Bug', self::TYPE_FEATURE=>'Feature',
                         self::TYPE_TASK=>'Task');
        }
        
        public function getStatusOptions()
            {
               return array(self::STATUS_NOTYETSTARTED=>'Not yet Started',  self::STATUS_STARTED=>'Started',
               self::STATUS_FINISHED=>'Finished');
            }
       public function getAllowedTypeRange(){
           return array(self::TYPE_BUG,  self::TYPE_FEATURE,self::TYPE_TASK);
       }
       
       public function getAllowedStatusRange(){
           return array(self::STATUS_NOTYETSTARTED,  self::STATUS_STARTED,self::STATUS_FINISHED);
       }
}